    ...
    <div className="min-h-screen flex flex-col bg-white font-['Atkinson_Hyperlegible',_sans-serif]">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#005260] via-[#007C8A] to-[#009DAD] pt-20 pb-28 px-6 lg:px-10">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
          ...
          <div className="bg-white/10 border border-white/15 rounded-[24px] p-8 flex flex-col gap-4">
            <span className="text-xs font-medium text-white/60">Pemandu aktif saat ini</span>
            <div className="grid grid-cols-3 gap-3">
              {[
                ...
                <div key={i} className="bg-white/10 border border-white/15 rounded-xl p-4 text-center">
                  ...
                  <div className="text-[10px] font-medium text-white/50 leading-tight mt-1">{stat.label}</div>
                </div>
              ))}
            </div>
            <div className="bg-white/12 border border-white/20 rounded-2xl p-5 flex items-center gap-4">
              <div className="w-11 h-11 rounded-full bg-white/20 flex items-center justify-center text-white font-bold text-sm">RS</div>
              <div>
                <div className="text-sm font-bold text-white">Rizky Santoso</div>
                <div className="text-[11px] font-medium text-white/50">Pemandu KRL Jabodetabek · ⭐ 4.9</div>
              </div>
              <div className="ml-auto bg-green-500/20 border border-green-500/40 rounded-full px-3 py-1 text-[10px] font-bold text-green-300 flex items-center gap-1">
                <span className="w-1.5 h-1.5 rounded-full bg-green-400 animate-pulse" /> Aktif
              </div>
            </div>
            <p className="text-[11px] font-medium text-white/40 text-center mt-1">Cocokkan pemandu sesuai kebutuhan Anda</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#F8FAFB] py-20 px-6 lg:px-10">
        <div className="max-w-5xl mx-auto">
          <div className="mb-12">
            <span className="text-[11px] font-bold text-[#007C8A] uppercase tracking-widest block mb-2">Keunggulan Program</span>
            <h2 className="text-3xl font-bold text-gray-900 mb-3">Mengapa Berlangganan ARAHIN?</h2>
            <p className="text-gray-500 font-medium text-base max-w-md">Setiap fitur dirancang khusus untuk kenyamanan dan keamanan perjalanan Anda</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {benefits.map((b, i) => (
              <div key={i} className="bg-white border border-gray-100 p-8 rounded-2xl hover:border-[#007C8A] transition-colors group cursor-default">
                ...
                <p className="text-gray-500 font-medium text-[13px] leading-relaxed">{b.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-[#007C8A] py-24 px-6 lg:px-10 relative overflow-hidden text-white">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <span className="text-xs font-bold text-white/60 uppercase tracking-widest">Investasi Terbaik</span>
            <h2 className="text-3xl font-bold leading-tight">Satu Langkah Menuju Perjalanan yang Lebih Mudah</h2>
            <p className="text-white/70 font-medium max-w-sm">Bergabung dengan ribuan pengguna yang sudah merasakan manfaat pemandu pribadi ARAHIN setiap harinya.</p>
          ...
          <Card className="bg-white border-none rounded-[20px] p-9 shadow-xl text-gray-900 relative z-10">
            ...
            <div className="text-[13px] font-bold text-gray-500 mb-2 uppercase tracking-wide">Paket Bulanan</div>
            <div className="text-4xl font-bold text-[#007C8A] flex items-baseline gap-1">
              Rp 299.000<span className="text-base text-gray-400 font-medium">/bln</span>
            </div>
            <div className="text-[12px] font-medium text-gray-400 mt-2 mb-6">Tagihan bulanan · batalkan kapan saja</div>
      ...
      <section className="bg-[#F8FAFB] py-20 px-6">
        <div className="max-w-2xl mx-auto">
          <div className="mb-10">
            <span className="text-[11px] font-bold text-[#007C8A] uppercase tracking-widest block mb-2">FAQ</span>
            <h2 className="text-3xl font-bold text-gray-900">Pertanyaan yang Sering Ditanyakan</h2>
          </div>
          ...
          <div className="space-y-3">
            {faqItems.map((item, idx) => (
              <div key={idx} className="bg-white border border-gray-200 rounded-xl overflow-hidden">
                ...
                >
                  <span className="text-[14px] font-bold text-gray-900">{item.question}</span>
          ...
          <div className="text-center mt-12">
            <p className="text-[14px] font-medium text-gray-500 mb-3">Masih ada pertanyaan?</p>
